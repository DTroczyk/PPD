            ...
            <div id="home" className="container">
              ...
              <div className="container">
                <svg xmlns="http://www.w3.org/2000/svg" width="600" height="500" viewBox="0 0 600 500" preserveAspectRatio="xMinYMin" className="birds">
                  {/* <rect className="box" x="45" y="15" width="30" height="30"></rect>
                  <circle cx="60" cy="30" r="5"></circle>
                  <rect className="box" x="75" y="15" width="30" height="30"></rect>
                  <circle cx="90" cy="30" r="5"></circle>
                  <rect className="box" x="105" y="15" width="30" height="30"></rect>
                  <circle cx="120" cy="30" r="5"></circle>
                  <rect className="box" x="135" y="15" width="30" height="30"></rect>
                  <circle cx="150" cy="30" r="5"></circle>
                  <rect className="box" x="165" y="15" width="30" height="30"></rect>
